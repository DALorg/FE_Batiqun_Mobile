...
export default function Products() {
  ...
  useEffect(() => {
    if (searching != null) {
      dispatch(getProducts(Pagess, count, searching));
    }
  }, [count, Search]);
  return (
    <div>
      ...
      <main>
        <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className="flex items-center justify-center">
            <button
              className="mt-10 text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex "
              type="button"
